...
> **Prefer a greenfield project?**  
> `dotnet new install Voluta.Templates` then  
> `dotnet new voluta-agent -n MyAgent` — HITL interrupt + offline MEAI stub.  
> Details: [Install · scaffold](/voluta/0.x/install#scaffold-dotnet-new-voluta-agent).
